...
## Corpus Check
- 35 files · ~10,627 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 187 nodes · 195 edges · 18 communities (13 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4f3a713a`
...
Cohesion: 0.12
Nodes (15): dependencies, @monaco-editor/react, next, react, react-dom, @supabase/ssr, @supabase/supabase-js, name (+7 more)
...
Cohesion: 0.50
Nodes (4): practice/demo/page.tsx, ast_hash, mtime, semantic_hash

## Knowledge Gaps
- **118 isolated node(s):** `MANDATORY: Query Graphify Before Reading Files`, `graphify`, `Graphify Usage`, `Graphify Usage`, `Session loop` (+113 more)
...
- **What connects `MANDATORY: Query Graphify Before Reading Files`, `graphify`, `Graphify Usage` to the rest of the system?**
