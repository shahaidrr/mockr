...
## Corpus Check
- 35 files · ~10,142 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 181 nodes · 189 edges · 17 communities (12 shown, 5 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `38e2be8b`
...
Cohesion: 0.07
Nodes (28): auth/signout/route.ts, ast_hash, mtime, semantic_hash, landingPage/page.tsx, ast_hash, mtime, semantic_hash (+20 more)
...
Cohesion: 0.50
Nodes (4): dashboard/page.tsx, ast_hash, mtime, semantic_hash
...
## Knowledge Gaps
- **113 isolated node(s):** `stats`, `recentAttempts`, `scoreBreakdown`, `weaknesses`, `metadata` (+108 more)
